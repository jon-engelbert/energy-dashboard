...
) ENGINE=InnoDB AUTO_INCREMENT=173 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
INSERT INTO `meters` VALUES (1,'7070-9500888','DTE','Electric','vID','1234926000',2),(2,'6666','DTE','Natural Gas','vID','1455584',2),(4,'A 222 2676 2873 11','DTE','Electric','vID','1980TM',3),(6,'5555','DTE','Electric','vID','226099',5),(7,'2000 4627 7253','DTE','Electric','vID','227976',5),(8,'4444','DTE','Electric','vID','252902 (224075)',5),(9,'7777','Consumers Energy','Natural Gas','vID','4234RT29/ 042-34',2),(14,'69705-01404','DTE','Electric','vID','777999851',1),(15,'11','ab','Electric','vID','ab11',7),(16,'12345','dte','Electric','vID','abcde',8),(17,'67890','consumers','Natural Gas','vID','qwerty',8);
...
INSERT INTO `schedule` VALUES (1,1,12,12,12,12,12,8,12,0,'ymca'),(2,2,8,8,8,8,8,4,0,NULL,'OE schedule');
...
INSERT INTO `users` VALUES (1,'','jon.a.engelbert@gmail.com','thien',1,1,1,1,0),(2,'','jon_engelbert@hotmail..com','jon',1,1,1,1,1),(4,'','cesarnerys@gmail.com','cesar',2,0,0,0,1);
...
INSERT INTO `v_user_role` VALUES ('cesar','098F6BCD4621D373CADE4E832627B4F6','super',4),('jon','098F6BCD4621D373CADE4E832627B4F6','SUPER',2),('thien','098F6BCD4621D373CADE4E832627B4F6','admin',1);
...
INSERT INTO `weatherstation` VALUES (1,'karb',5508,1362,240,6,-125.2,5.8,60),(2,'wkrp',2500,2000,25,3.2,20,2.5,60);
...
-- Dump completed on 2012-03-12 23:27:34
